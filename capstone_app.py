...
if(choice=='Home'):
    ...
    st.altair_chart(alt.Chart(dataframe).mark_line(color='yellow').encode(x=alt.X('entry_id:O',axis=alt.Axis(labelAngle=-45)),y='field1:Q').interactive(),use_container_width=True)
