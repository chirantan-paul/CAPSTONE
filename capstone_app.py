...
if(choice=='Home'):
    ...
    st.write(dataframe)
    st.write("Line Chart for Voltage(V)")
    ...
    st.write("Line Chart for Current(mA)")
    ...
    st.write("Line Chart for Power(W)")
    ...
    st.write("Line Chart Comparison of Voltage(V), Current(mA) and Power(W)")
    ...
    st.write("Area Chart for Voltage(V)")
    ...
    st.write("Area Chart for Current(mA)")
    ...
    st.write("Area Chart for Power(W)")
    ...
    st.write("Bar Chart for Voltage(V)")
    ...
    st.write("Bar Chart for Current(mA)")
    ...
    st.write("Bar Chart for Power(W)")
