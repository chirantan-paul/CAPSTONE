...
if(choice=='Home'):
    ...
    st.altair_chart(alt.Chart(dataframe).mark_bar().encode(x='entry_id:O',y='field2:N'),use_container_width=True)
    st.altair_chart(alt.Chart(dataframe).mark_bar().encode(x='entry_id:O',y='field3:N'),use_container_width=True)
